    ...
    <head>
        ...
        <style>
            ...
            <style>
                ...
                .header-common-bg {
                    background: linear-gradient(0deg, #57c2fff2 0%, #00000000 100%);
                }
            </style>
                <style>
                    .ai-chat-section{
                  ...
                  <style>
                    ...
                    .ai-chat-section::-webkit-scrollbar-track {
                      background: #031a13; /* Track color */
                    }
                
                    .ai-chat-section::-webkit-scrollbar-thumb {
                      background-color: #002e6b; /* Scroll thumb color */
                      border-radius: 10px; /* Scroll thumb roundness */
                      border: 2px solid #031a13; /* Adds space around the thumb */
                    }
                
                    .ai-chat-section::-webkit-scrollbar-thumb:hover {
                      background-color: #002767; /* Thumb color on hover */
                    }
                  </style>
                  <style>
                    .custom-card {
                        background: linear-gradient(18deg, #071d5f, #031a13);
                  ...
                  <style>
                    ...
                    animation: gradient-blur 4s ease-in-out infinite, color-shift 8s ease-in-out infinite;
                    }
                ...
                <div class="container mx-auto px-4 py-4 flex justify-between items-center">
                  ...
                  <div class="flex space-x-6">
                      <a href="{{ route('profile.edit') }}" 
                           class="rounded-md px-6 py-3 text-white transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:hover:text-white/80 dark:focus-visible:ring-white shadow-md hover:shadow-lg">
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="flex">
                          ...
                          <a href="route('logout')" class="rounded-md px-6 py-3 text-white transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:hover:text-white/80 dark:focus-visible:ring-white shadow-md hover:shadow-lg"
